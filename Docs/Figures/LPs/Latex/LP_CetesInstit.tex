...
\begin{document}
	\begin{figure}[tbph]
		\caption{Response of Cetes Flows to Target and Path Surprises} \label{fig:LPCetesInstit}
		\begin{center}
			\begin{minipage}{\linewidth}
				\begin{center}
					\begin{subfigure}[t]{\linewidth}
						\includegraphics[trim={0.3cm 0.23cm 0.3cm 0.23cm},clip,height=0.35\textheight,width=\linewidth]{../Figures/LPs/Target/Cetes/Target11CetesInstit1.eps} \\
						\vspace{-0.35cm}
						\caption{Target  Surprise} \label{subfig:Target11CetesInstit}
						\vspace{0.4cm}
					\end{subfigure}
					...
					\begin{subfigure}[t]{\linewidth}
						\includegraphics[trim={0.3cm 0.23cm 0.3cm 0.23cm},clip,height=0.35\textheight,width=\linewidth]{../Figures/LPs/Path/Cetes/Path11CetesInstit1.eps} \\
						\vspace{-0.35cm}
						\caption{Path Surprise} \label{subfig:Path11CetesInstit}
						\vspace{0.0cm}
					\end{subfigure}
				\end{center}
